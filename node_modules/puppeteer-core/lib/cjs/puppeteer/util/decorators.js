...
function moveable(Class, _) {
    ...
    if (Class.prototype[disposablestack_js_1.Symbol.dispose]) {
        const dispose = Class.prototype[disposablestack_js_1.Symbol.dispose];
        Class.prototype[disposablestack_js_1.Symbol.dispose] = function () {
    ...
    if (Class.prototype[disposablestack_js_1.Symbol.asyncDispose]) {
        const asyncDispose = Class.prototype[disposablestack_js_1.Symbol.asyncDispose];
        Class.prototype[disposablestack_js_1.Symbol.asyncDispose] = function () {
            if (instances.has(this)) {
                instances.delete(this);
                return;
            }
